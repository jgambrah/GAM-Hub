 ...
 * Integrates the Reputation System Rank Badges.
 */
...
import { getRank } from './ArenaChampions';
      ...
      <div className="bg-slate-950 rounded-[3.5rem] p-8 border-4 border-slate-900 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-4">
          {filteredLegends.map((legend, i) => {
            const rank = getRank(legend.wins, legend.highlightCount || 0);
            return (
              <div 
                key={legend.userId}
                className={cn(
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className={cn("mt-1 px-2 py-0.5 rounded-md text-[7px] font-black uppercase tracking-widest shadow-sm w-fit", rank.color, rank.textColor)}>
